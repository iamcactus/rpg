module.exports = {
  ...
  RES_CODE : {
    SUC_OK						: 1,		// success
    LOGIN_COMPLETE          : 200,  // login success
    REGIST_SUCCESS          : 201,  // regist success
    ...
    ERR_WRONG_DEVICE_INFO   : -101,   // unvalid device info for quick login
    ERR_DUPLICATE_REQUEST   : -102,   // duplicate request, just reject 
    ERR_QUICKACCOUNT_FAIL   : -103,   // failed to create quick accout
  },
